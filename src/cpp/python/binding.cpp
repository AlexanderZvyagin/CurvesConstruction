...
PYBIND11_MODULE(curves, m) {
    ...
    py::class_<YieldCurve> (m, "YieldCurve")
        ...
        // .def("GetYields", &YieldCurve::GetYields)
        // .def("GetYield", [] (const YieldCurve &c,TimePoint t) {return c.GetYield(t);})
        // .def("GetYield", [] (const YieldCurve &c,TimePeriod t) {return c.GetYield(t);})
        // .def("SetYield", [] (YieldCurve &c,TimePoint t,float y) {return c.SetYield(t,y);})
        // .def("SetYield", [] (YieldCurve &c,TimePeriod t,float y) {return c.SetYield(t,y);})
        ...
        // .def("GetForwardRate", [] (const YieldCurve &c,float t1,float t2) {return c.GetForwardRate(t1,t2);})
